...
be reported to the project maintainers through GitHub's
[private vulnerability reporting](https://github.com/whipedev/ivycode/security/advisories/new)
form (used here as a private channel until a dedicated address is set up).
